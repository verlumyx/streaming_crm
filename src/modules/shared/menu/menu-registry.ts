...
export const MENU_REGISTRY: readonly MenuDefinition[] = [
  ...
  { id: '019e8a10-0007-7000-a000-000000000007', parentId: null, title: 'Transacciones manuales', url: '/manual-transactions', permission: 'manual-transactions.list', icon: 'NotebookPen', order: 8, section: 'main' },
  { id: REPORTS_ID, parentId: null, title: 'Reportes', url: '/reports/movements', permission: 'reports.movements', icon: 'ChartColumn', order: 9, section: 'main' },
